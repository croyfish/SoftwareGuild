 ...
 * @author jeffc
 */
public class FortuneCooke {
    public static void main(String[] args) {
        Random randomizer = new Random();
        int cookie = randomizer.nextInt(10);
        ...
        switch (cookie) {
            ...
            break;
            case 3: System.out.println("With great power there must also come - great responsibiliity.");
            break;
            case 4: System.out.println("Never argue with the data.");
            break;
            case 5: System.out.println("Try not. Do, or do not. There is no try.");
            break;
            case 6: System.out.println("You are a leaf on wind, watch how you soar.");
            break;
