...
-- -----------------------------------------------------
-- Schema SuperSightings_Query
-- -----------------------------------------------------
DROP SCHEMA IF EXISTS `SuperSightings_Query` ;

-- -----------------------------------------------------
-- Schema SuperSightings_Query
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `SuperSightings_Query` DEFAULT CHARACTER SET utf8 ;
USE `SuperSightings_Query` ;


-- -----------------------------------------------------
-- Table `SuperSightings_Query`.`Address`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `SuperSightings_Query`.`Address` ;

CREATE TABLE IF NOT EXISTS `SuperSightings_Query`.`Address` (
...
-- -----------------------------------------------------
-- Table `SuperSightings_Query`.`Location`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `SuperSightings_Query`.`Location` ;

CREATE TABLE IF NOT EXISTS `SuperSightings_Query`.`Location` (
  ...
  CONSTRAINT `fk_Location_Address`
    ...
    REFERENCES `SuperSightings_Query`.`Address` (`AddressId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `SuperSightings_Query`.`Sighting`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `SuperSightings_Query`.`Sighting` ;

CREATE TABLE IF NOT EXISTS `SuperSightings_Query`.`Sighting` (
  ...
  CONSTRAINT `fk_Sighting_Location1`
    ...
    REFERENCES `SuperSightings_Query`.`Location` (`LocationId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `SuperSightings_Query`.`SuperPerson`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `SuperSightings_Query`.`SuperPerson` ;

CREATE TABLE IF NOT EXISTS `SuperSightings_Query`.`SuperPerson` (
...
-- -----------------------------------------------------
-- Table `SuperSightings_Query`.`Organization`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `SuperSightings_Query`.`Organization` ;

CREATE TABLE IF NOT EXISTS `SuperSightings_Query`.`Organization` (
...
-- -----------------------------------------------------
-- Table `SuperSightings_Query`.`Power`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `SuperSightings_Query`.`Power` ;

CREATE TABLE IF NOT EXISTS `SuperSightings_Query`.`Power` (
...
-- -----------------------------------------------------
-- Table `SuperSightings_Query`.`SuperPerson_Organization`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `SuperSightings_Query`.`SuperPerson_Organization` ;

CREATE TABLE IF NOT EXISTS `SuperSightings_Query`.`SuperPerson_Organization` (
  ...
  CONSTRAINT `fk_SuperPerson_Organization_SuperPerson1`
    ...
    REFERENCES `SuperSightings_Query`.`SuperPerson` (`SuperPersonId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_SuperPerson_Organization_Organization1`
    FOREIGN KEY (`OrganizationId`)
    REFERENCES `SuperSightings_Query`.`Organization` (`OrganizationId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `SuperSightings_Query`.`SuperPerson_Power`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `SuperSightings_Query`.`SuperPerson_Power` ;

CREATE TABLE IF NOT EXISTS `SuperSightings_Query`.`SuperPerson_Power` (
  ...
  CONSTRAINT `fk_SuperPerson_Power_Power1`
    FOREIGN KEY (`PowerId`)
    REFERENCES `SuperSightings_Query`.`Power` (`PowerId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `SuperSightings_Query`.`SuperPerson_Sighting`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `SuperSightings_Query`.`SuperPerson_Sighting` ;

CREATE TABLE IF NOT EXISTS `SuperSightings_Query`.`SuperPerson_Sighting` (
  ...
  CONSTRAINT `fk_SuperPerson_Sighting_Sighting1`
    ...
    REFERENCES `SuperSightings_Query`.`Sighting` (`SightingId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
INSERT INTO `Sighting` VALUES (6, '20151129', 3, NULL);
