...
public class SuperPersonServiceTest {
    ...
    private static CreateAndAddObjectsForServiceTests co = 
            new CreateAndAddObjectsForServiceTests();
...
// Assert
    ...
    public void testGetAllSuperPersonsBySightingLocation() {
        ...
        SuperPerson sp1 = createAndAddSuperPerson();
        SuperPerson sp2 = createAndAddSuperPerson();
        SuperPerson sp3 = createAndAddSuperPerson();
    ...
    public void testGetAllSuperPersonsByOrganization() {
        ...
        //make some orgs
        Organization o1 = createAndAddOrganization();
        Organization o2 = createAndAddOrganization();
    ...
    public void testAddSuperPersonToOrganization_Integer_Integer() {
        ...
        Organization o = co.createAndAddOrganization();
        SuperPersonOrganization spo = superPersonService.
                addSuperPersonToOrganization(sp.getSuperPersonId(), o.getOrganizationId());
    }
