    ...
    <body>
        <div class="container">
            ...
            <div class="row">
                ...
                -->
                <div class="col-md-6">
                    <h2>Selected Sighting: <c:out value="${svm.sighting.sightingId}"/> </h2>
                    <div class="row">
                        Date: <c:out value="${svm.sighting.date}     "/>
                    ...
                    <div><!-- should be a table -->
                        <table id="sightingTable" class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <td><a href="chooseSighting?sightingClicked=${currentSVM.sighting.sightingId}"><c:out value="${currentSVM.sighting.date}"/></a></td>                                           
                                        <td><a href="chooseSighting?sightingClicked=${currentSVM.sighting.sightingId}">
                                            <c:forEach 
                                        ...
                                        <td><a href="chooseSighting?sightingClicked=${currentSVM.sighting.sightingId}"><c:out value="${currentSVM.location.name}"/></a></td>        
